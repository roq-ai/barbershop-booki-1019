...
import { getWorkingHourById } from 'apiSdk/working-hours';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Working Hour Detail View
          </Text>
          {hasAccess('working_hour', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/working-hours/edit/${data?.id}`} passHref legacyBehavior>
              <Button
